...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['impersonate', 'panel', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    // Active Sessions Management (Device Management)
    Route::group(['prefix' => 'active-sessions'], function () {
        Route::get('/', 'ActiveSessionsController@index');
        Route::get('/stats', 'ActiveSessionsController@stats');
        Route::delete('/{id}', 'ActiveSessionsController@destroy');
        Route::post('/destroy-others', 'ActiveSessionsController@destroyOthers');
    });

    // Registered Devices Management
    Route::group(['prefix' => 'registered-devices'], function () {
        Route::get('/', 'RegisteredDevicesController@index');
        Route::get('/stats', 'RegisteredDevicesController@stats');
        Route::post('/{id}/trust', 'RegisteredDevicesController@updateTrust');
        Route::delete('/{id}', 'RegisteredDevicesController@destroy');
    });
    ...
    Route::group(['prefix' => 'financial'], function () {
        ...
        Route::get('/tutor-earnings', 'TutorEarningsController@index');
        Route::get('/tutor-payouts', 'TutorPayoutsController@index');
        Route::post('/tutor-payouts/request', 'TutorPayoutsController@requestPayout');
