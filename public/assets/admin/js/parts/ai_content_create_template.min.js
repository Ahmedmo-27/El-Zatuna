/******/ (() => { // webpackBootstrap
/*!****************************************************************!*\
  !*** ./resources/js/admin/parts/ai_content_create_template.js ***!
  \****************************************************************/
(function ($) {
  "use strict";
  ...
  $('body').on('change', '.js-template-type', function (e) {
    var value = $(this).val();
    var $text = $('.js-text-fields');
    var $image = $('.js-image-fields');
    var $prompt = $('.js-prompt-field');
    var $textPromptHint = $('.js-text-prompt-hint');
    var $imagePromptHint = $('.js-image-prompt-hint');
