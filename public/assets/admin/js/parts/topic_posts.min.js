/******/ (() => { // webpackBootstrap
/*!*************************************************!*\
  !*** ./resources/js/admin/parts/topic_posts.js ***!
  \*************************************************/
(function ($) {
  "use strict";
    ...
    $.post(action, {}, function (result) {
      if (result && result.code === 200) {
        if (topicBookmarkedSuccessfullyLang && topicUnBookmarkedSuccessfullyLang) {
          var _result$title;
          var type = result.add ? 'success' : 'warning';
          var msg = result.add ? topicBookmarkedSuccessfullyLang : topicUnBookmarkedSuccessfullyLang;
          showToast(type, (_result$title = result.title) !== null && _result$title !== void 0 ? _result$title : '', msg);
        }
      } else {
        Swal.fire(oopsLang, somethingWentWrongLang, 'error');
      }
