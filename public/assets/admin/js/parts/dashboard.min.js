/******/ (() => { // webpackBootstrap
/*!***********************************************!*\
  !*** ./resources/js/admin/parts/dashboard.js ***!
  \***********************************************/
...
var chart = {};
window.makeStatisticsChart = function (name, section, badge, labels, datasets) {
...
function getSaleStatisticsData(type) {
  $.post(adminPanelPrefix + '/dashboard/getSaleStatisticsData', {
    type: type
  }, function (result) {
