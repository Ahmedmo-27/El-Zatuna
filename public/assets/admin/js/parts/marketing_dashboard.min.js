/******/ (() => { // webpackBootstrap
/*!*********************************************************!*\
  !*** ./resources/js/admin/parts/marketing_dashboard.js ***!
  \*********************************************************/
...
var chart;
window.makeClassesStatisticsChart = function (badge, labels, datasets) {
...
window.makeNetProfitChart = function (badge, labels, datasets) {
...
function getSaleStatisticsData(type) {
  $.post(adminPanelPrefix + '/marketing/getNetProfitChart', {
    type: type
  }, function (result) {
