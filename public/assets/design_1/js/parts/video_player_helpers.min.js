...
(function ($) {
  ...
  window.makeVideoPlayerHtml = function (path, storage, height, tagId) {
    ...
    if (storage === 'youtube') {
      ...
      html = "<video id=\"".concat(tagId, "\" class=\"plyr-io-video\" controls preload=\"auto\" width=\"100%\" height=\"100%\" data-poster=\"").concat(thumbnail !== null && thumbnail !== void 0 ? thumbnail : '', "\">\n                <source src=\"").concat(path, "\" type=\"").concat(sourceType, "\"/>\n            </video>");
    }
    return {
      html: html,
      options: options
