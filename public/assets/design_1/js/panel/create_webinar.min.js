  ...
  function initPanelCategoryInput() {
    ...
    function doSearch(q) {
      ...
      $.get('/become-instructor/search-subjects', {
        ...
        $results.empty();
        if (!results.length) {
          if (q) $results.append($('<div class="p-2 text-[#072923]/50">No matching categories. Use "Add different subject" below to add "' + $('<div>').text(q).html() + '".</div>'));else $results.append($('<div class="p-2 text-[#072923]/50">No categories found.</div>'));
        } else {
