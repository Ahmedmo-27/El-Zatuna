/******/ (() => { // webpackBootstrap
/*!**************************************************!*\
  !*** ./resources/js/design_1/panel/dashboard.js ***!
  \**************************************************/
(function ($) {
  "use strict";
  ...
  function handleInstructorSalesOverviewChart() {
    var series = [{
      name: courseSalesLang,
      data: instructorSalesOverviewChartCourseSales
    }, {
      name: meetingSalesLang,
      data: instructorSalesOverviewChartMeetingSales
    }, {
      name: productSalesLang,
      data: instructorSalesOverviewChartProductSales
    }];
    var colors = ["rgba(22, 93, 255, 0.3)", "rgba(205, 213, 226, 0.3)", "rgba(63, 205, 130, 0.3)"];
    var labels = instructorSalesOverviewChartLabels;
    var $elDiv = document.querySelector("#instructorSalesOverviewChart");
    handleApexAreaCharts($elDiv, series, colors, labels, 354, jsCurrentCurrency, "before");
  }
  function handleActivityChart(labels, data) {
    var series = [{
      name: learningActivityLang,
      data: data
    }];
    var colors = ["rgba(22, 93, 255, 0.3)"];
    var $elDiv = document.querySelector("#learningActivityChart");
    handleApexAreaCharts($elDiv, series, colors, labels, 354, " ".concat(minsLang), "after");
  }
  ...
  function handleVisitorsStatisticsChart(labels, data) {
    ...
    var colors = ["rgba(1, 112, 255, 0.4)"];
    var $elDiv = document.querySelector("#visitorsStatisticsChart");
  ...
  ********** */
  $('body').on('click', '.js-show-noticeboard-info', function (e) {
    e.preventDefault();
    var $this = $(this);
    var noticeboardId = $this.attr('data-id');
    var $parent = $this.closest('.js-noticeboard-card');
    var $senderDiv = $parent.find('.js-noticeboard-sender-info');
    var message = $this.parent().find('input').val();
    var html = "\n            <div class=\"d-flex align-items-center bg-gray-100 rounded-16 p-16\">".concat($senderDiv.html(), "</div>\n            <div class=\"bg-white border-gray-100 rounded-12 p-16 mt-32 mb-16 text-black white-space-pre-wrap\">").concat(message, "</div>");
    Swal.fire({
