/******/ (() => { // webpackBootstrap
/*!*************************************************!*\
  !*** ./resources/js/design_1/panel/comments.js ***!
  \*************************************************/
(function ($) {
  "use strict";
  ...
  $('body').on('click', '.js-view-comment', function (e) {
    ...
    var comment_id = $this.attr('data-comment-id');
    var comment = $('#commentDescription' + comment_id).val();
    var html = '<div class="p-20">' + '<div class="section-title">' + '<h3 class="section-title__heading">' + commentLang + '</h3>' + '</div>' + '<p class="font-weight-500 text-gray-500 mt-20">' + comment + '</p>' + '</div>';
    Swal.fire({
      html: html,
      showCancelButton: false,
      showConfirmButton: false,
