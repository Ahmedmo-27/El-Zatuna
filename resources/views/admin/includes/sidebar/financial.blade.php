...
@can('admin_documents')
            ...
            @can('admin_sales_list')
                <li class="nav-item {{ (request()->is(getAdminPanelUrl('/financial/tutor-earnings*', false))) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl() }}/financial/tutor-earnings" class="nav-link">
                        <x-iconsax-bul-empty-wallet-change class="icons" width="24px" height="24px"/>
                        <span>{{ trans('update.tutor_earnings') }}</span>
                    </a>
                </li>
            @endcan

            @can('admin_payouts')
                <li class="nav-item {{ (request()->is(getAdminPanelUrl('/financial/tutor-payouts*', false))) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl() }}/financial/tutor-payouts" class="nav-link">
                        <x-iconsax-bul-empty-wallet-change class="icons" width="24px" height="24px"/>
                        <span>{{ trans('update.tutor_payouts') }}</span>
                    </a>
                </li>
            @endcan
