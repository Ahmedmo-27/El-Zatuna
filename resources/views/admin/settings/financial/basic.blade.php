    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                <div class="form-group">
                    <label>{{ trans('update.tutor_platform_fee') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-percentage"></i>
                        ...
                        <input type="text" name="value[tutor_platform_fee]" value="{{ (!empty($itemValue) and isset($itemValue['tutor_platform_fee'])) ? $itemValue['tutor_platform_fee'] : old('tutor_platform_fee') }}" class="form-control text-center" oninput="validatePrice(this)"/>
                    </div>
                    <div class="text-gray-500 text-small mt-1">{{ trans('update.tutor_platform_fee_hint') }}</div>
                </div>
