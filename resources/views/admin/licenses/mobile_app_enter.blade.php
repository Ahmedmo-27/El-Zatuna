            ...
            <div class="row">
                            ...
                            <form class="mb-0" action="{{ route('admin.mobile_app.license.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-muted font-12 mt-2">
                                        Please enter your Elzatuna Mobile App purchase code. This code has 36 characters.
                                    </div>
                                </div>
                ...
                <div class="col-12 col-lg-7 mt-4 mt-lg-0">
                    <div class="card rounded-24">
                         <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>Elzatuna Mobile App Information</h4>
                        </div>
                            ...
                            <div class="mt-4">
                                 ...
                                 <div class="feature-item rounded-16 border-gray-300">
                                    ...
                                    <div class="feature-content">
                                       <h5>What is the Mobile App?</h5>
                                        <p class="text-gray-500">The Elzatuna Mobile App extends the capabilities of your main Elzatuna installation with a native mobile application for iOS and Android devices.</p>
                                    </div>
                                </div>
                                 ...
                                 <div class="feature-item rounded-16 border-gray-300">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p class="text-gray-500">Mobile App requires a separate purchase code from your main Elzatuna license. Make sure you're entering the correct purchase code.</p>
                                    </div>
                                </div>
