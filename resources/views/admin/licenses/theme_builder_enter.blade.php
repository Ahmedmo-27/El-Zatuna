        ...
        <div class="section-body">
            <div class="row">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.theme-builder.license.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-muted font-12 mt-2">Please enter your Elzatuna Theme Builder purchase code.This code has 32 characters.</div>
                                </div>
                ...
                <div class="col-12 col-lg-7 mt-4 mt-lg-0">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>Elzatuna Theme Builder and landing page builder Information</h4>
                        </div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="feature-icon bg-primary-30 text-primary">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p class="text-gray-500">Theme Builder requires a separate purchase code from your main Elzatuna license. Make sure you're entering the correct purchase code.</p>
                                    </div>
                                </div>
