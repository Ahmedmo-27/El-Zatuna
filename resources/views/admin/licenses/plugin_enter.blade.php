                        ...
                        <div class="card-body">
                            <form class="mb-0" action="{{ route('admin.plugin.license.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-muted font-12 mt-2">Please enter your Elzatuna Plugins Bundle purchase code. This code has 32 characters.</div>
                                </div>
            ...
            <div class="d-flex align-items-center mt-4 text-end justify-content-end">
                ...
                <div class="col-12 col-lg-7 mt-4 mt-lg-0">
                    <div class="card rounded-24">
                         <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>Elzatuna Plugins Bundle Information</h4>
                        </div>
                            ...
                            <div class="mt-4">
                                 ...
                                 <div class="feature-item rounded-16 border-gray-300">
                                    ...
                                    <div class="feature-content">
                                       <h5>What is Plugins Bundle?</h5>
                                        <p class="text-gray-500">The Elzatuna Plugins Bundle extends the capabilities of your main Elzatuna installation with additional features and integrations.</p>
                                    </div>
                                </div>
                                 ...
                                 <div class="feature-item rounded-16 border-gray-300">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p class="text-gray-500">Plugins Bundle requires a separate purchase code from your main Elzatuna license. Make sure you're entering the correct purchase code.</p>
                                    </div>
                                </div>
