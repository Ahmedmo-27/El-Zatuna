                        ...
                        <form action="{{ getAdminPanelUrl() }}/financial/subscribes/{{ !empty($subscribe) ? $subscribe->id.'/update' : 'store' }}" method="Post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subtitle"
                                       ...
                                       value="{{ !empty($subscribe) ? $subscribe->subtitle : old('subtitle') }}"/>
                                @error('subtitle')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group custom-switches-stacked">
                                <label class="custom-switch pl-0">
                                    <input type="hidden" name="access_all_courses" value="0">
                                    <input type="checkbox" name="access_all_courses" id="accessAllCoursesSwitch" value="1" {{ (!empty($subscribe) and $subscribe->access_all_courses) ? 'checked="checked"' : '' }} class="custom-switch-input"/>
                                    <span class="custom-switch-indicator"></span>
                                    <label class="custom-switch-description mb-0 cursor-pointer" for="accessAllCoursesSwitch">{{ trans('update.access_all_courses') }}</label>
                                </label>
                            </div>
