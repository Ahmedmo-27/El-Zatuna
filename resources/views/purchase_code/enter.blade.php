    ...
    <div class="page-container">
        ...
        <div class="card-stack">
            ...
            <div class="card rounded-24">
                <div class="card-body">
                        <div class="mb-4">
                            <img src="{{ asset('assets/design_1/img/logo.svg') }}" alt="Elzatuna" class="img-fluid">
                        </div>

                    <h1 class="card-title">@yield('heading', 'License Verification')</h1>
                    <p class="card-subtitle">Enter your Elzatuna purchase code to verify your license</p>
