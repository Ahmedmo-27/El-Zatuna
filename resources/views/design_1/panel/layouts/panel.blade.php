    ...
    <script>
        (function ($) {
            ...
            $('body').on('click', '.js-show-panel-sidebar', function (e) {
                e.preventDefault();
                $('#panelSidebar').toggleClass('show');
                $('.panel-sidebar__mask').toggleClass('show');
            });

            $('body').on('click', '.panel-sidebar__mask', function (e) {
                e.preventDefault();
                $('#panelSidebar').removeClass('show');
                $('.panel-sidebar__mask').removeClass('show');
            });
        })(jQuery);
    </script>
