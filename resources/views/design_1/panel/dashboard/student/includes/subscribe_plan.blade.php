...
@else
    <div class="student-dashboard__no-subscribe-card p-16 rounded-24">
        ...
        <a href="/panel/financial/subscribes" target="_blank" class="d-inline-flex-center px-16 py-8 rounded-32 bg-white mt-16" style="color: #072923;">{{ trans('update.upgrade') }}</a>
    </div>
@endif
