<div class="panel-header d-flex align-items-center bg-white px-24 px-lg-0">
    ...
    <div class="panel-header__contents d-flex align-items-center justify-content-between h-100">
        ...
        <div class="d-flex align-items-center">
            ...
            {{-- Multi Color (Dark,Light) - Hidden for El Zatuna theme --}}
            <div class="js-theme-color-toggle theme-color-toggle theme-color-toggle__panel {{ "{$userThemeColorMode}-mode" }} d-none size-16 bg-gray-100 rounded-8 mr-16 mr-lg-32">
