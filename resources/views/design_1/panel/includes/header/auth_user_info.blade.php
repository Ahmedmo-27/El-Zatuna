<div class="navbar-auth-user">
    <div class="d-flex align-items-center">
        ...
        <div class="d-none d-lg-block ml-8">
            ...
            @if(!empty($isPanelNav))
                <span class="font-12 text-gray-500">{{ $authUser->role->caption ?? $authUser->role_name }}</span>
            @endif
        </div>
    ...
    <div class="navbar-auth-user__dropdown {{ !empty($isPanelNav) ? 'is-panel-nav' : '' }}">
        <div class="d-flex align-items-center m-4 rounded-10 bg-gray p-12">
            ...
            <div class="ml-8 flex-1">
                ...
                <span class="mt-4 text-gray-500 font-12">{{ $authUser->role->caption ?? $authUser->role_name }}</span>
            </div>
        </div>
