...
<div class="bg-white rounded-16 p-16 mt-32">
    ...
    @php
        $extraDesc = $webinar->webinarExtraDescription ?? collect();
        $learningMaterials = $extraDesc->where('type', 'learning_materials');
        $requirements = $extraDesc->where('type', 'requirements');
    @endphp
