    ...
    <form method="POST" action="/register" class="mt-16">
        ...
        <div class="auth-page-form-container pr-16 mt-16 pt-16" data-simplebar @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
            ...
            <div class="form-group">
                ...
                <select name="university_id" id="university_id" class="js-university-select form-control @error('university_id') is-invalid @enderror">
            ...
            <div class="form-group">
                ...
                <select name="faculty_id" id="faculty_id" class="js-faculty-select form-control @error('faculty_id') is-invalid @enderror" data-selected-faculty="{{ old('faculty_id') }}">
