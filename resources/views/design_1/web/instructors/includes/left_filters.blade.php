    ...
    <div id="leftFiltersAccordion" class="position-relative bg-[#072923] py-16 rounded-24 z-index-2">
        ...
        <div class="accordion card-before-line card-before-line__4-12 py-16 px-16 pb-4 border-bottom-gray-100">
            <div class="accordion__title d-flex align-items-center justify-content-between">
                <div class="font-14 font-weight-bold text-[#FAFFE0] cursor-pointer" href="#leftFiltersSkills" data-parent="#leftFiltersAccordion" role="button" data-toggle="collapse">
...
<div class="position-relative instructors-lists-filters mt-28">
    ...
    <div id="leftFiltersAccordion2" class="position-relative bg-[#072923] py-16 rounded-24 z-index-2">
        ...
        <div class="accordion card-before-line card-before-line__4-12 py-16 px-16 pb-4 border-bottom-gray-100">
            <div class="accordion__title d-flex align-items-center justify-content-between">
                <div class="font-14 font-weight-bold text-[#FAFFE0] cursor-pointer" href="#leftFiltersOtherOptions" data-parent="#leftFiltersAccordion2" role="button" data-toggle="collapse">
