@if(!empty($topInstructors) and count($topInstructors))
    <div class="instructors-lists__top-users rounded-32 mt-56 p-24 bg-[#072923]">
        <div class="d-flex-center flex-column text-center pt-24">
            <h2 class="font-32 text-[#FAFFE0]">{{ trans('update.top_instructors') }}</h2>
            <div class="text-[#FAFFE0]/75 opacity-75">{{ trans('update.enjoy_learning_from_top_instructors_and_get_valuable_information') }}</div>
        </div>
