...
@section("content")
    <main class="pb-56">
        ...
        <form action="/instructors" class="js-get-view-data-by-timeout-change max-w-7xl mx-auto px-8" data-container-id="listsContainer">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9 mt-12">
                    <div id="listsContainer" class="" data-body=".js-lists-body" data-view-data-path="/instructors">
                        ...
                        <div class="js-lists-body row mt-20">
                            @foreach($users as $user)
                                <div class="col-12 col-lg-6 mt-16">
                                    @include('design_1.web.instructors.components.cards.grids.grid_card_1', ['instructor' => $user])
                                </div>
                            @endforeach
                        </div>
