                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="university_id" id="university_id" class="form-control form-control-lg" required>
                                    <option value="" {{ empty(old('university_id')) ? 'selected' : '' }}>Select university</option>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="faculty_id" id="faculty_id" class="form-control form-control-lg" required disabled>
                                    <option value="" {{ empty(old('faculty_id')) ? 'selected' : '' }}>Select university first</option>
                                    @foreach($faculties as $faculty)
                                        <option value="{{ $faculty->id }}" data-university-id="{{ $faculty->university_id }}" {{ old('faculty_id') == $faculty->id ? 'selected' : '' }}>{{ $faculty->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
