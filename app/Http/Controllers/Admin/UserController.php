...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'password' => ['required', 'string', new \App\Rules\StrongPassword($data['full_name'] ?? null)],
            'status' => 'required',
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->handleUserCertificateAdditional($user->id, $data['certificate_additional'] ?? null);
