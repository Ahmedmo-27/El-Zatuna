    ...
    */
    ...
    private function stepTwo(Request $request)
    {
        ...
        if ($tokenData['step'] !== 2) {
            ...
            return back()->withErrors(['verification_token' => 'This token is not valid for step 2'])->withInput();
        }
        ...
        if (!$user) {
            ...
            return back()->withErrors(['verification_token' => 'User not found'])->withInput();
        }
