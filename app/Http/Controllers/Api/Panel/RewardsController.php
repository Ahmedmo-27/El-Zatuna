...
class RewardsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $rewardsQuery = RewardAccounting::where('user_id', $user->id);
        
        $paginatedRewards = apiPagination(
            $rewardsQuery,
            $request,
            function ($reward) {
                return $reward->details;
            },
            url('/api/' . config('app.api_version', 'development') . '/panel/rewards')
        );
        ...
        $data = [
            ...
            'rewards' => $paginatedRewards['items'],
            'pagination' => $paginatedRewards['pagination'],
