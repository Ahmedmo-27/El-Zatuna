...
class Webinar extends Model implements TranslatableContract
{
    ...
    {
        static::addGlobalScope('universityFaculty', function (Builder $builder) {
            $user = auth()->user();

            if (empty($user) && function_exists('apiAuth')) {
                $user = apiAuth();
            }
    ...
    private static function studentWantsAllCourses(): bool
    {
